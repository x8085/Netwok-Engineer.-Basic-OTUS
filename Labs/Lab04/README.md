...
**copy running-config startup-config**  
**reload**  
Скриншоты процесса настройки ниже:  
![](SSH_R1.png)  
![](SSH_R1_1.png)  
![](SSH_R1_2.png)  
...
**copy running-config startup-config**  
**reload**  
Скриншоты процесса настройки приведены ниже:  
![](Switch_1.png)  
![](Switch_2.png)  
...
![](Connect_SSH_to_S1_1.png)  
Удалось ли вам установить SSH-соединение с коммутатором?  
**Да, удалось.**  
![](Connect_SSH_to_S1_2.png)  
Закройте окно настройки.
...
**Необходимо включить опцию обращения к локальной базе командой _login local_**  
