...
**Далее сравниваются номера портов на корневом коммутаторе и приоритет отдается интерфейсу с наименьшим номером интерфейса Root-коммутатора, к которому подключен интерфейс некорневого коммутатора**  
