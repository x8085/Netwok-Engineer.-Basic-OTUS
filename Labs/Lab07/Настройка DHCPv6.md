...
![](Configure_S1_1.png)  
![](Configure_S1_2.png)  
Базовую настройку всех коммутаторов можно посмотреть [здесь](Config/).  
...
**copy running-config startup-config**  
![](Configure_R1_1.png)  
Базовую настройку всех маршрутизаторов можно посмотреть [здесь](Config/).  
...
**ipv6 route 2001:db8:acad:2::1/64 2001:db8:acad:2::2**  
**exit**  
c.	Убедитесь, что маршрутизация работает с помощью пинга адреса G0/0/1 R2 из R1.  
d.	Сохраните текущую конфигурацию в файл загрузочной конфигурации.  
**copy running-config startup-config**  
Закройте окно настройки.  
Настройки интерфейсов маршрутизаторов можно посмотреть [здесь](Config/).
#### Часть 2. Проверка назначения адреса SLAAC от R1.
