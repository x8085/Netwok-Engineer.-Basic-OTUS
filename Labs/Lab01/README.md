...
~~**_Тут есть вопрос: не совсем понятно какие устройства? Также вопрос, почему у одного коммутатора интерфейс 0/18, а у всех остальных 0/1? Также на понятно чей мас-0004.9ac2.aaba(я разобрался,это интерфейс vlan1)_**~~  
**На компьютере PC-B откройте командную строку и еще раз введите команду *arp -a*.**  
