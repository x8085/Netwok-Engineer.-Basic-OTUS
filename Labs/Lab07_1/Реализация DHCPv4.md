...
**_у меня интерфейс F0/5 после всех настроек указан в VLAN 1000 (native vlan)_**  
...
![](ipconfig_all_PC-B.png)  
b.	После завершения процесса обновления выполните команду ipconfig для просмотра новой информации об IP-адресе.  
![](ipconfig_PC-B.png)  
c.	Проверьте подключение с помощью пинга IP-адреса интерфейса R1 G0/0/1.  
![](ping_g01_R1_fron_PC-B.png)  
d.	Выполните show ip dhcp binding для R1 для проверки назначений адресов в DHCP.  
![](Show_ip_DHCP_binding_R1_Part3_Step2.png)  
e.	Выполните команду show ip dhcp server statistics для проверки сообщений DHCP.  
![](Show_ip_DHCP_server_statistics_R1_Part3_Step2.png)  
**Нет такой команды в CPT.**  
