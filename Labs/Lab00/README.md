...
Потому что у нас нет никакого конфига и показывать нечего.    
...
**Какие выходные данные вы видите?**  
Вижу что порты поднялись (треугольнички стали зелеными).  
...
Он включается автоматически при подключении кабеля Ethernet. На маршрутизаторе вводим команду no shutdown  
...
Чтобы включить доступ к VTY (чтобы система запрашивала пароль при входе).  
