...
**Вопросы:**  
Во что был транслирован внутренний локальный адрес PC-B?  
**Внутренний локальный адрес PC-B был транслирован в 209.165.200.228**   
Какой тип адреса NAT является переведенным адресом?  
**Переведенный адрес является PAT** (~~по выводу непонятно~~).   
Чем отличаются выходные данные команды show ip nat translations из упражнения NAT?  
Введите ваш ответ здесь.
**В выводе должна использоваться нумерация портов (сокетов)** (~~но в выводе я не увидел нумерацию сокетов~~)   
b.	С PC-A, запустите эхо-запрос интерфейса Lo1 (209.165.200.1) на R2. Если эхо-запрос не прошел, выполните отладку. На R1 отобразите таблицу NAT на R1 с помощью команды **show ip nat translations**.  
_R1# show ip nat translations_  
Pro Inside global Inside local Outside local Outside global  
...
![](Show_ip_nat_translations_after_ping_from_PC-A_PC-B_to_Loopback1_part3_step3.png)  
**Вопрос:**  
Как маршрутизатор отслеживает, куда идут ответы?  
**Маршрутизатор определяет куда отправлять пакеты по номерам портов (сокетов)**   
...
Total number of translations: 1  
![](Show_ip_nat_translations_after_part4_step3.png)  
...
Total number of translations: 2  
![](Show_ip_nat_translations_after_ping_from_R2_part4_step3.png)  
